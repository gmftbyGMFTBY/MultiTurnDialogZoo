...
class GCNRNN(nn.Module):
    ...
    def forward(self, src, tgt, gbatch, lengths):
        ...
        context_output = self.gcncontext(gbatch, turns)
    ...
    def predict(self, src, gbatch, maxlen, lengths):
        ...
        context_output = self.gcncontext(gbatch, turns)    # [batch, turn, hidden]
        # context_output = context_output.permute(1, 0, 2)    # [turn, batch, hidden]
