...
'''
Seq2Seq with Multi head Attention
'''
...
class Decoder(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, output_size, n_layers=2, dropout=0.5, nhead=8, pretrained=None):
    ...
    def forward(self, inpt, last_hidden, encoder_outputs):
        ...
        context = self.attention(key, encoder_outputs)    # [1, batch, seq]
